...
<div class="container modal-protext">
    ...
    <h5 class="modal-title" id="prod_title"><?=$product_name?>
    </h5>
...
<div class="modal-body p-0">
    ...
    <div class="osahan-filter">
        ...
        <div class="filter">
            ...
            $res=campaign_resturant_buy_variant($campaign_vendor_id, $product_id);

    $i=1;
                
    while ($row=mysqli_fetch_array($res)) {
        $free_variant= campaign_resturant_free_variant($row['campaign_vendor_product_id']); ?>
            ...
            <div class="custom-control border-bottom px-0  custom-radio">
                ...
                <input type="radio" id="prod_varient<?=$i?>"
                    ...
                    data-campaign-vendor-product-id="<?=$row['campaign_vendor_product_id']?>"
                    >
                ...
                <label class="custom-control-label py-5 w-100 px-3"
                    ...
                    <strike>(+<?=$currency?>
                        ...
                        <?=$row['price']?>)</strike>
                    <!-- free product varient -->
                    <p><?='Free '.$free_variant['quantity'].' '.$free_variant['unit'].' '.$free_variant['product_name']?>
                    </p>
                </label>
        ...
        ?>
            ...
            <div class="container">
                ...
                <label class="containerchk"><?=$addon['addon_name']?>
                    ...
                    <input type="checkbox" name="product_addons_checkbox"
                        class="product_addons_checkbox product_addons_chk"
...
<div class="modal-footer p-0 border-0">
    ...
    <div class="col-12 m-0 p-0">
        ...
        <input type="hidden" id="estimated_delivery_time"
            value="<?=$_POST['estimated_delivery_time']?>">
        ...
        <button type="button" class="btn btn-cart btn-lg btn-block add-to-cart" data-type=""><span
                class="product_price_btn"></span><span class="cart_btn">Add To Cart</span></button>
