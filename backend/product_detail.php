...
<div class="container modal-protext">
    ...
    <h5 class="modal-title" id="prod_title"></h5>
...
<div class="modal-footer p-0 border-0">
    ...
    <div class="col-12 m-0 p-0">
        ...
        <input type="hidden" id="restaurant_name" value="<?=$_POST['vendor_name']?>">

        <input type="hidden" id="estimated_delivery_time" value="<?=$_POST['estimated_delivery_time']?>">
        
        <input type="hidden" id="is_campaign" value="no">
